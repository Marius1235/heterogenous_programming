...
TOPDIR = '/Users/raghava/opt/anaconda3/conda-meta'
TOPDIR = '/Users/raghava/Documents'
...
def sequential():
    ...
    print ('sequential execution: ',end-start,"seconds")
    return digest_map
...
def parallel():
    ...
    print ('parallel execution: ', end-start,"seconds")
    return digest_map
