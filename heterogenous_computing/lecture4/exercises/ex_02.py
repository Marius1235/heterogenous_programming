...
def cubed_row(row: List[int]) -> int:
    '''
...
def apply_cubed_row_sequential(data: List[List[int]]) -> List[int]:
    '''
...
if __name__ == '__main__':
    ...
    # timing the sequential solution
        ...
        seq_result = apply_cubed_row_sequential(data)
        ...
        with mp.Pool(8) as p:
            ...
            result_parallel = p.map(cubed_row, data)
