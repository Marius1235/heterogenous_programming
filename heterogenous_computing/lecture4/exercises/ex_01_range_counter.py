...
if __name__ == '__main__':
    ...
    arr = np.random.randint(0, 10, size=[90_000_000, 10])
    ...
    print(f'finished Parallel execution in {round(finish-start, 2)} seconds')
    print('First 10 results of the sequential result', result_parallel[:10])
